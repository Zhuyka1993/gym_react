...
const sections = {
  gym: {
    ...
    items: [
      ...
      {
        productName: "Заняття з тренером (додатково до абонементу)",
        price: "240 грн",
      },
      {
        productName: "Складання програми тренувань (разове)",
        price: "300 грн",
      },
      {
        productName: "Складання разової програми харчування (разове)",
        price: "300 грн",
      },
      {
        productName: "Складання програми харчування на 1 місяць",
        price: "650 грн",
      },
      { productName: "10 занять з тренером", price: "1900 грн" },
      { productName: "12 занять з тренером", price: "2200 грн" },
      {
        productName: "Тренування у вечірній час по абонементу до 17:00",
        price: "30 грн",
      },
  ...
  fitness: {
    ...
    items: [
      ...
      {
        productName: "Абонемент 12 занять + тренажерний зал",
        price: "650 грн",
      },
      {
        productName: "Абонемент на 12 місяців + тренажерний зал",
        price: "4600 грн",
      },
      { productName: "Разове заняття", price: "100 грн" },
